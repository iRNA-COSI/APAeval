...
def check_samplesheet(file_in, file_out):
    ...
    with open(file_in, "r") as fin:
        ...
        ## Check header
        MIN_COLS = 4
        HEADER = ['sample','condition','bam', 'bai']
        ...
        for line in fin:
            ...
            sample, condition, bam, bai = lspl[:len(HEADER)]
            if sample:
                if sample.find(" ") != -1:
            ...
            sample_info = [ sample, condition, bam, bai ]
    ...
    if len(sample_info_list) > 0:
        ...
        with open(file_out, "w") as fout:
            fout.write(",".join(['sample','condition','bam', 'bai']) + "\n")
