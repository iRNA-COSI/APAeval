...
def check_samplesheet(file_in, file_out):
    ...
    sample,fastq1,fastq2,gtf,fasta,bed,mart_export
    """
    ...
    with open(file_in, "r") as fin:
        ...
        ## Check header
        MIN_COLS = 5
        HEADER = ['sample','fastq1','fastq2','gtf','fasta','bed','mart_export']
        ...
        for line in fin:
            ...
            sample, fastq1, fastq2, gtf, fasta, bed, mart_export = lspl[:len(HEADER)]
            if sample:
                if sample.find(" ") != -1:
            ...
            sample_info = [ sample, fastq1, fastq2, gtf, fasta, bed, mart_export ]
    ...
    if len(sample_info_list) > 0:
        ...
        with open(file_out, "w") as fout:
            fout.write(",".join(['sample','fastq1','fastq2','gtf','fasta','bed','mart_export']) + "\n")
