...
# Input bams
bam1 <- list.files(pattern=paste0(args[2], ".*bam")) # args[2] is pattern matching bams from condition 1
bam2 <- list.files(pattern=paste0(args[3], ".*bam")) # args[3] is pattern matching bams from condition 2
bams <- c(bam1, bam2)
# Output prefix
out.prefix <- args[4]
