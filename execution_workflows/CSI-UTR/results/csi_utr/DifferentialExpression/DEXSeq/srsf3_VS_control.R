...
setwd("/home/fzhuang/apaeval/APAeval/execution_workflows/CSI-UTR/./results/csi_utr//DifferentialExpression/DEXSeq/srsf3_VS_control/")
fileArr = c("../../../DEXSeq/siControl_R1_2genes_Chr_prefix.DEXSeq.counts", "../../../DEXSeq/siSrsf3_R1_2genes_Chr_prefix.DEXSeq.counts")
gffFile = "../../../DEXSeq/siControl_R1_2genes_Chr_prefix.DEXSeq.gff"
sampleTable = data.frame(
   row.names=c("siControl_R1_2genes_Chr_prefix", "siSrsf3_R1_2genes_Chr_prefix"),
   condition=c("A_control", "B_srsf3"),
...
write.table(defExp, file="allCSIs_srsf3_VS_control_SORTED.txt", sep="\t")
write.table(diffExpRegions, file="allCSIs_srsf3_VS_control_BYREGION.txt", sep="\t")
write.table(sigFDR, file="sigCSIs_srsf3_VS_control.txt", sep="\t")
