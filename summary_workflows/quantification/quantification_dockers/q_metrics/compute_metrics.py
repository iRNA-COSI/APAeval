...
def compute_metrics(participant_input, gold_standards_dir, challenge_ids, participant, community, out_path, windows, genome_path):
    ...
    for challenge in challenge_ids:
        ...
        for window in windows:
            ...
            match_with_gt_run = matchPAS.match_with_gt(participant_input,gold_standard,window,return_df_type="with_unmatched_GT_and_PD")
            ...
            # Key: exact name of metric as it appears in specification
            metric_name = f"Correlation_coefficient_Spearman_{window}nt"
            # Value: List of [variable_holding_metric, std_err]
            ...
            if window == windows[0]:
                ...
                # Key: exact name of metric as it appears in specification
                metric_name = f"Correlation_coefficient_Spearman_relative_{window}nt"
                # Value: List of [variable_holding_metric, std_err]
